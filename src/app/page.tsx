			...
			<MaxWidthWrapper className='mb-12 mt-28 sm:mt-40 flex flex-col items-center justify-center text-center'>
				...
				<Link
					className={buttonVariants({
						size: 'lg',
						className: 'mt-5 hover:bg-violet-300',
					})}
					href='/dashboard'
					target='_blank'
				>
					...
					<div>
						<div className='mx-auto max-w-6xl px-6 lg:px-8'>
							<div className='mt-16 flow-root sm:mt-24'>
								<div className='-m-2 rounded-xl bg-gray-900/5 p-2 ring-1 ring-inset ring-gray-200/10 lg:-m-4 lg:rounded-2xl lg:p-4'>
									<Image
				...
				<ol className='my-8 space-y-4 pt-8 md:flex md:space-x-12 md:space-y-0'>
					...
					<li className='md:flex-1'>
						<div className='flex flex-col space-y-2 border-l-4 border-slate-400 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4'>
							...
							<span className='mt-2 text-slate-700'>
								Either starting out with a free plan or choose our We&apos;ll
								process your file and make it ready for you to chat with.
							</span>
						</div>
					</li>
					<li className='md:flex-1'>
						<div className='flex flex-col space-y-2 border-l-4 border-slate-400 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4'>
							...
							<span className='mt-2 text-slate-700'>
								It really is that simple. Try out Quill today.
							</span>
						</div>
					</li>
				</ol>
